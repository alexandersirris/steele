...
Original file is located at
    https://colab.research.google.com/drive/1hCelFdDqtWAdgR9YVnwPsYMWPpHQrZgh
...
# build the data frame and send to csv file
df.query('Shop_Region == "US West"').to_csv('/datalab/Product Adoption/2022/June/Delta Analysis/6_30.csv')

df = diff_pd(df1.reindex(sorted(df1.columns), axis=1), df2.reindex(sorted(df2.columns), axis=1))
